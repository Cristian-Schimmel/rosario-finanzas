...
export const metadata = {
  title: 'Análisis | Rosario Finanzas',
  description: 'Análisis financiero exclusivo y opinión editorial de Rosario Finanzas.',
};
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted dark:text-slate-400">
                Opinión editorial y análisis exclusivo de nuestra redacción
              </p>
            </div>
          </div>
        </header>
        ...
        {editorialArticles.length === 0 ? (
          <Card className="p-12 text-center">
            ...
            <p className="text-text-secondary max-w-md mx-auto">
              Nuestro equipo editorial está preparando análisis exclusivos sobre mercados, 
              economía y finanzas de la región. Muy pronto encontrarás contenido aquí.
            </p>
            <Link 
              href="/noticias" 
